...
public class MakeFlowFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        linearLayout = (LinearLayout) view.findViewById(R.id.fragment_flow_make_flow);
            ...
            getChildFragmentManager().setFragmentResultListener("requestKey", this, new FragmentResultListener() {
                ...
                public void onFragmentResult(@NonNull String requestKey, @NonNull Bundle result) {
                  ...
                  //  listItems.add(flowItemData.getItem(imageNumber).getImage());
                    TextView textView = makeTextView(getActivity(), imageNumber);
                }
            });
        }
    }

    private TextView makeTextView(Context context, int imageNumber) {
